        ...
        {academics.map((item, idx) => (
          ...
          >
            ...
            <div className="relative z-10 px-8 pt-8 pb-4 h-full flex flex-col justify-between">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none group-hover:opacity-0 transition-opacity duration-300 z-30 pt-10">
              ...
              <div className="flex flex-col justify-end flex-grow blur-xl opacity-20 scale-95 group-hover:scale-100 group-hover:blur-none group-hover:opacity-100 transition-all duration-[600ms] ease-out pt-4">
